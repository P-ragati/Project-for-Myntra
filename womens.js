...
womensData.map(function(element) {
    ...
    var prelovedButton = document.createElement("button");
    prelovedButton.textContent = "Preloved";
    prelovedButton.style.cursor = "pointer";
    prelovedButton.setAttribute("class", "prelovedButton");
    
    prelovedButton.addEventListener("click", function() {
        window.location.href = element.preloved_url;
    });
    ...
    box.append(prelovedButton,img, contentBox);
